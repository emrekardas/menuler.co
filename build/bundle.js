...
var app = (function () {
    ...
    const file$4 = "src/searchBar.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$4, 12, 4, 241);
    			attr_dev(div, "class", "svelte-1iw5xc0");
    			add_location(div, file$4, 11, 2, 231);
    		},
    ...
    const file$3 = "src/citiesFilter.svelte";
    ...
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(option, file$3, 16, 8, 483);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			option.__value = "";
    			option.value = option.__value;
    			add_location(option, file$3, 14, 6, 407);
    			add_location(select, file$3, 13, 4, 334);
    			attr_dev(div, "class", "svelte-1iw5xc0");
    			add_location(div, file$3, 12, 2, 324);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$2 = "src/categoryFilter.svelte";
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			i = element("i");
    			t = space();
    			attr_dev(i, "class", "" + (null_to_empty(/*category*/ ctx[5].name) + " svelte-17n6hdn"));
    			if (!src_url_equal(i.src, i_src_value = /*category*/ ctx[5].src)) attr_dev(i, "src", i_src_value);
    			add_location(i, file$2, 24, 8, 717);

    			attr_dev(button, "class", button_class_value = "" + (null_to_empty(/*selectedCategory*/ ctx[0] === /*category*/ ctx[5].name
    			? 'active'
    			: '') + " svelte-17n6hdn"));

    			add_location(button, file$2, 20, 6, 565);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*selectedCategory*/ 1 && button_class_value !== (button_class_value = "" + (null_to_empty(/*selectedCategory*/ ctx[0] === /*category*/ ctx[5].name
    			? 'active'
    			: '') + " svelte-17n6hdn"))) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(20:4) {#each categories as category}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 18, 2, 518);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const click_handler = category => handleCategoryFilter(category.name);
    ...
    class CategoryFilter extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { selectedCategory: 0, onCategoryFilter: 3 });
    ...
    const file$1 = "src/restaurantList.svelte";
    ...
    // (55:10) {#if (!selectedCity || mekan.şehir === selectedCity) && (!selectedCategory || mekan.kategori === selectedCategory)}
    function create_if_block(ctx) {
    	let li;
    	let t_value = /*mekan*/ ctx[9]['mekan-ismi'] + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(li, file$1, 55, 12, 1625);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*filteredMekanlar*/ 1 && t_value !== (t_value = /*mekan*/ ctx[9]['mekan-ismi'] + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(55:10) {#if (!selectedCity || mekan.şehir === selectedCity) && (!selectedCategory || mekan.kategori === selectedCategory)}",
    		ctx
    	});
    ...
    // (54:8) {#each filteredMekanlar as mekan}
    function create_each_block(ctx) {
    	let if_block_anchor;
    	let if_block = (!/*selectedCity*/ ctx[1] || /*mekan*/ ctx[9].şehir === /*selectedCity*/ ctx[1]) && (!/*selectedCategory*/ ctx[2] || /*mekan*/ ctx[9].kategori === /*selectedCategory*/ ctx[2]) && create_if_block(ctx);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if ((!/*selectedCity*/ ctx[1] || /*mekan*/ ctx[9].şehir === /*selectedCity*/ ctx[1]) && (!/*selectedCategory*/ ctx[2] || /*mekan*/ ctx[9].kategori === /*selectedCategory*/ ctx[2])) {
    				if (if_block) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(54:8) {#each filteredMekanlar as mekan}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	citiesfilter = new CitiesFilter({ $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 46, 4, 1223);
    			attr_dev(ul, "class", "svelte-e137r9");
    			add_location(ul, file$1, 52, 4, 1440);
    			add_location(main, file$1, 45, 2, 1212);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function applyCityFilter() {
    		if (selectedCity) {
    			$$invalidate(0, filteredMekanlar = mekanlar.filter(mekan => mekan.şehir === selectedCity));
    			console.log(selectedCity, 'seçildi');
    		} else {
    			$$invalidate(0, filteredMekanlar = mekanlar);
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<RestaurantList> was created with unknown prop '${key}'`);
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 6, 1, 91);
    			add_location(main, file, 5, 2, 83);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ RestaurantList });
    	return [];
    }
