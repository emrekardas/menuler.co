...
var app = (function () {
    ...
    // (24:2) {#each categories as category}
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			img = element("img");
    			t = space();
    			if (!src_url_equal(img.src, img_src_value = /*category*/ ctx[5].src)) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", /*category*/ ctx[5].name);
    			add_location(img, file$2, 28, 6, 774);
    			toggle_class(button, "selected", /*selectedCategory*/ ctx[0] === /*category*/ ctx[5].name);
    			add_location(button, file$2, 24, 4, 637);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(24:2) {#each categories as category}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 22, 0, 594);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn(`<CategoryFilter> was created with unknown prop '${key}'`);
    	});
    ...
    // (60:10) {#if (!selectedCity || mekan.şehir === selectedCity) && (!selectedCategory || mekan.kategori === selectedCategory)}
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(li, file$1, 60, 12, 1716);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(60:10) {#if (!selectedCity || mekan.şehir === selectedCity) && (!selectedCategory || mekan.kategori === selectedCategory)}",
    		ctx
    	});
    ...
    // (59:8) {#each filteredMekanlar as mekan}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(59:8) {#each filteredMekanlar as mekan}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 51, 4, 1286);
    			attr_dev(ul, "class", "svelte-e137r9");
    			add_location(ul, file$1, 57, 4, 1531);
    			add_location(main, file$1, 50, 2, 1275);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
