...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 19, 0, 482);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class CategoryFilter extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { selectedCategory: 0, onCategoryFilter: 3 });
    ...
    // (56:10) {#if (!selectedCity || mekan.şehir === selectedCity) && (!selectedCategory || mekan.kategori === selectedCategory)}
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(li, file$1, 56, 12, 1712);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(56:10) {#if (!selectedCity || mekan.şehir === selectedCity) && (!selectedCategory || mekan.kategori === selectedCategory)}",
    		ctx
    	});
    ...
    // (55:8) {#each filteredMekanlar as mekan}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(55:8) {#each filteredMekanlar as mekan}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 47, 4, 1282);
    			attr_dev(ul, "class", "svelte-e137r9");
    			add_location(ul, file$1, 53, 4, 1527);
    			add_location(main, file$1, 46, 2, 1271);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 6, 1, 138);
    			add_location(main, file, 5, 2, 130);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ RestaurantList, Geolocation });
    	return [];
    }
